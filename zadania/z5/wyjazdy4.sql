...
CREATE TABLE pracownik_kopia (
  ...
  nazwisko VARCHAR(45) not NULL,
  auto_id  integer null,
  FOREIGN KEY (auto_id) REFERENCES auto_kopia(auto_id)
);
...
CREATE TABLE pw (
  ...
  FOREIGN KEY (cel_id) REFERENCES cel(cel_id)
);
...
insert into pw (pracownik_id,cel_id) values (1,2);
insert into pw (pracownik_id,cel_id) values (2,2);
insert into pw (pracownik_id,cel_id) values (1,3);
insert into pw (pracownik_id,cel_id) values (3,1);

insert into wyjazdy (pracownik_id,data) values (1,'2017-11-02');
insert into wyjazdy (pracownik_id,data) values (2,'2017-11-03');
insert into wyjazdy (pracownik_id,data) values (3,'2017-11-04');
insert into wyjazdy (pracownik_id,data) values (4,'2017-11-02');
